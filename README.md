...
9. Change the variable aws_region to the region you set in step 5 
10. Change the variable bucket_name to the name of the S3 bucket created in step 6.
11. Save the changes and close the file.
12. Run rekognition_demo.py script from terminal using the command: python rekognition_demo.py
